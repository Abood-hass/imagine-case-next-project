...
function index({ configuration }: { configuration: Configuration }) {
    ...
    const { label: moduleLabel } = MODELS.options.find(({ value }) => value === model)!

    let totalPrice = BASE_PRICE + PRODUCT_CONFIG.material[material!] + PRODUCT_CONFIG.finish[finish!]
                                ...
                                <div className='flow-root text-sm'>
                                    ...
                                    {material === "polycarbonate" ? (
                                        <div className='flex items-center justify-between py-1 mt-2'>
                                            ...
                                            <p className='font-medium text-gray-900'>
                                                {formatPrice(PRODUCT_CONFIG.material.polycarbonate / 100)}
                                            </p>
                                        </div>
                                    ) : (<></>)}
